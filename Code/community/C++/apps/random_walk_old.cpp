...
// g++ random_walk.cpp graph.cpp -fopenmp
...
void visited_count_from_all_node(vector<unordered_map<int, int>>& count_dict, Graph& graph, unordered_set<int>& change_node_set, int change_flow)
{
...
int main()
{
    ...
    vector<string> graph_list = {"p2p-Gnutella24"};
    unordered_set<int> change_node_set;
    int change_flow = RANDOM_WALK_NUM;
