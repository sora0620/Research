...
class Graph
{
    ...
    public:
        ...
        void calc_edge_ppr_by_fora_flow_time(unordered_map<pair<int, int>, double, pairhash>& edge_ppr, int src_id, int walk_count, int flow_rwer, double alpha=0.15, double r_max_coef=1.0) const;
